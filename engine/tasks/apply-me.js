...
exports.applyConfig = function(){	
	...
	var index_html = fs.readFileSync('tmpls/index-tmpl.html', 'ascii');
	var post_template = fs.readFileSync('tmpls/post-tmpl.html', 'ascii');
	...
	fs.writeFile('js/views/templates/posts/post.html', out_post_template.toString('utf8'), function(err) {
		...
		console.log('[Generate] templates/posts/post.html');
	}); 
}